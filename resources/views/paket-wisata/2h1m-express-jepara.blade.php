                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Rp {{ number_format(760000 + 20000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Fan Kamar Mandi Dalam</td>
                                        <td>Rp {{ number_format(785000 + 20000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="bg-primary text-white">
                                        ...
                                        <td>Rp {{ number_format(1310000 + 20000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                    ...
                                    <tr class="bg-primary text-white">
                                        ...
                                        <td>Rp {{ number_format(1460000 - 70000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                        <td>Java Paradise Resort - Superior</td>
                                        <td>Rp {{ number_format(1460000 - 25000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                    ...
                                    <tr class="bg-primary text-white">
                                        ...
                                        <td>Rp {{ number_format(1060000 + 20000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                        <td>LUMBUNG</td>
                                        <td>Rp {{ number_format(1160000 + 20000 + 100000, 0) }}</td>
