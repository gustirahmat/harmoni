                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Rp {{ number_format(910000 + 20000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr>
                                        <td>Fan Kamar Mandi Dalam</td>
                                        <td>Rp {{ number_format(960000 + 20000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="bg-primary text-white">
                                        ...
                                        <td>Rp {{ number_format(1710000 + 20000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                        <td>d'SEASON - Bisnis</td>
                                        <td>Rp {{ number_format(1810000 + 20000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                    ...
                                    <tr class="bg-primary text-white">
                                        ...
                                        <td>Rp {{ number_format(2060000 - 160000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                        <td>Java Paradise Resort - Superior</td>
                                        <td>Rp {{ number_format(2060000 - 70000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                    ...
                                    <tr>
                                        ...
                                        <td>PURI Karimun</td>
                                        <td>Rp {{ number_format(1460000 + 20000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="bg-primary text-white">
                                        ...
                                        <td>Rp {{ number_format(1510000 + 20000 + 100000 + 150000, 0) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
