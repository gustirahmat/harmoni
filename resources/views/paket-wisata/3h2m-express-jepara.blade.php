            ...
            <div class="col-md-12">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Rp {{ number_format(960000 + 20000, 0) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="bg-primary text-white">
                                        ...
                                        <td>Rp {{ number_format(1710000 + 20000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                        <td>d'SEASON - Bisnis</td>
                                        <td>Rp {{ number_format(1810000 + 20000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                    ...
                                    <tr class="bg-primary text-white">
                                        ...
                                        <td>Rp {{ number_format(2060000 - 160000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                        <td>Java Paradise Resort - Superior</td>
                                        <td>Rp {{ number_format(2060000 - 70000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                        <td>Java Paradise Resort - Deluxe</td>
                                        <td>Rp {{ number_format(2060000 + 20000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                    ...
                                    <tr>
                                        ...
                                        <td>Rp {{ number_format(1760000 + 20000, 0) }}</td>
                                    </tr>
                                    <tr>
                                        <td>MANGROVE INN</td>
                                        <td>Rp {{ number_format(1460000 + 20000, 0) }}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Rp {{ number_format(1410000 + 20000, 0) }}</td>
                                    </tr>
                                    <tr>
                                        <td>ESCAPE - Deluxe</td>
                                        <td>Rp {{ number_format(1460000 + 20000, 0) }}</td>
                                    ...
                                    <tr class="bg-primary text-white">
                                        <td>ALCHY - Cendana</td>
                                        <td>Rp {{ number_format(1610000 + 20000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                        <td>ALCHY - Waru</td>
                                        <td>Rp {{ number_format(1810000 + 20000, 0) }}</td>
                                    ...
                                    <tr class="bg-primary text-white">
                                        <td>SUNRISE - Suite</td>
                                        <td>Rp {{ number_format(1560000 + 20000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="fb-comments" data-href="{{ route('3h2m-ebj') }}" data-width="100%" data-numposts="10"></div>
                    </div>
                </div>
            </div>
        </div>
