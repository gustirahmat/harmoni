        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-primary text-white">
                                        ...
                                        <td>Rp {{ number_format(1900000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                        <td>d'SEASON - Bisnis</td>
                                        <td>Rp {{ number_format(2000000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                        <td>d'SEASON - Executive</td>
                                        <td>Rp {{ number_format(2100000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                        <td>Java Paradise Resort - Standard</td>
                                        <td>Rp {{ number_format(2250000 - 180000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                        <td>Java Paradise Resort - Superior</td>
                                        <td>Rp {{ number_format(2250000 - 90000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                        <td>Java Paradise Resort - Deluxe</td>
                                        <td>Rp {{ number_format(2250000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                        <td>Java Paradise Resort - Executive</td>
                                        <td>Rp {{ number_format(2400000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr>
                                        <td rowspan="9">Hotel Standard / Melati</td>
                                        <td>PURI Karimun</td>
                                        <td>Rp {{ number_format(1650000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>Rp {{ number_format(1700000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>Rp {{ number_format(1950000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr>
                                        <td>MANGROVE INN</td>
                                        <td>Rp {{ number_format(1650000 + 100000, 0) }}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Rp {{ number_format(1600000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr>
                                        <td>ESCAPE - Deluxe</td>
                                        <td>Rp {{ number_format(1650000 + 100000, 0) }}</td>
                                    ...
                                    <tr class="bg-primary text-white">
                                        ...
                                        <td>Rp {{ number_format(1550000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                    ...
                                    <tr class="bg-primary text-white">
                                        <td>ALCHY - Cendana</td>
                                        <td>Rp {{ number_format(1800000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                                        <td>ALCHY - Waru</td>
                                        <td>Rp {{ number_format(2000000 + 100000, 0) }}</td>
                                    ...
                                    <tr class="bg-primary text-white">
                                        <td>SUNRISE - Suite</td>
                                        <td>Rp {{ number_format(1750000 + 100000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="title m-b-md text-center">
                            Itinerary 3H2M via Express Bahari Semarang
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="fb-comments" data-href="{{ route('3h2m-ebs') }}" data-width="100%" data-numposts="10"></div>
                    </div>
                </div>
            </div>
        </div>
