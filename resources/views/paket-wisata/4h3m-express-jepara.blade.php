                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Rp {{ number_format(1035000 + 20000, 0) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>PURI Karimun</td>
                                        <td>Rp {{ number_format(1660000 + 20000, 0) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>Rp {{ number_format(2160000 + 20000, 0) }}</td>
                                    </tr>
                                    <tr>
                                        <td>MANGROVE INN</td>
                                        <td>Rp {{ number_format(1660000 + 20000, 0) }}</td>
                                    ...
                                    <tr>
                                        <td>ESCAPE - Suite</td>
                                        <td>Rp {{ number_format(1860000 + 20000, 0) }}</td>
                                    </tr>
                                    <tr class="bg-primary text-white">
