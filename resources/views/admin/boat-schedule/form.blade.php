<div class="form-group {{ $errors->has('hari') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="hari" type="text" id="hari" value="{{ $boatschedule->hari ?? ''}}" required>
...
<div class="form-group {{ $errors->has('nama_kapal') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="nama_kapal" type="text" id="nama_kapal" value="{{ $boatschedule->nama_kapal ?? ''}}" required>
...
<div class="form-group {{ $errors->has('lokasi_pelabuhan') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="lokasi_pelabuhan" type="text" id="lokasi_pelabuhan" value="{{ $boatschedule->lokasi_pelabuhan ?? ''}}" required>
...
<div class="form-group {{ $errors->has('menuju_karimunjawa') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="menuju_karimunjawa" type="time" id="menuju_karimunjawa" value="{{ $boatschedule->menuju_karimunjawa ?? ''}}" required>
...
<div class="form-group {{ $errors->has('dari_karimunjawa') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="dari_karimunjawa" type="time" id="dari_karimunjawa" value="{{ $boatschedule->dari_karimunjawa ?? ''}}" required>
