<div class="form-group {{ $errors->has('nama_tamu') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="nama_tamu" type="text" id="nama_tamu" value="{{ $testimony->nama_tamu or ''}}" required>
...
<div class="form-group {{ $errors->has('testimoni') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" rows="5" name="testimoni" type="textarea" id="testimoni" required>{{ $testimony->testimoni or ''}}</textarea>
...
<div class="form-group {{ $errors->has('tanggal_trip') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="tanggal_trip" type="date" id="tanggal_trip" value="{{ $testimony->tanggal_trip or ''}}" required>
...
<div class="form-group {{ $errors->has('domisili_tamu') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="domisili_tamu" type="text" id="domisili_tamu" value="{{ $testimony->domisili_tamu or ''}}" required>
