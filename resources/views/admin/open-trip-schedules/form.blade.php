<div class="form-group {{ $errors->has('nama_trip') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="nama_trip" type="text" id="nama_trip" value="{{ $opentripschedule->nama_trip ?? ''}}" required>
...
<div class="form-group {{ $errors->has('kuota_trip') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="kuota_trip" type="number" id="kuota_trip" value="{{ $opentripschedule->kuota_trip ?? ''}}" required>
...
<div class="form-group {{ $errors->has('tanggal_trip') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="tanggal_trip" type="date" id="tanggal_trip" value="{{ $opentripschedule->tanggal_trip ?? ''}}" required>
...
<div class="form-group {{ $errors->has('lama_trip') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="lama_trip" type="text" id="lama_trip" value="{{ $opentripschedule->lama_trip ?? ''}}" required>
